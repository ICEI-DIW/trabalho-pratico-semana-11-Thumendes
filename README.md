...
- Nome: Arthur Mendes Pereira
- Matricula: 876331
- Proposta de projeto escolhida: Pontos Turísticos
- Breve descrição sobre seu projeto: Um site que lista os principais pontos turísticos do mundo e detalha algumas informações para os turistas interessados como: Atividades, Horários, Contatos, Localização através do mapa e muitas imagens

**Print do teste da API com visualização do JSON**

![JSON Preview](json-preview.png)

**Print da aba NETWORK com requisições Fetch/XHR**

![Network Preview](network-preview.png)
